...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('default_priority', withdrawal_priority_enum, nullable=False, server_default='normal'),
        sa.Column('default_lot_selection', lot_selection_method_enum, nullable=False, server_default='tax_opt'),
    ...
    op.create_table(
        ...
        sa.Column('priority', withdrawal_priority_enum, nullable=False, server_default='normal'),
        sa.Column('lot_selection', lot_selection_method_enum, nullable=False, server_default='tax_opt'),
        sa.Column('status', withdrawal_status_enum, nullable=False, server_default='draft'),
    ...
    op.create_table(
        ...
        sa.Column('liquidity_profile_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('account_id', postgresql.UUID(as_uuid=True), nullable=True),
        sa.Column('flow_type', cash_flow_type_enum, nullable=False),
