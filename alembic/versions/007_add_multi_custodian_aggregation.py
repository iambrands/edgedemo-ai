...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('custodian_type', custodiantype_enum, nullable=False, unique=True),
    ...
    op.create_table(
        ...
        sa.Column('status', connectionstatus_enum, nullable=False, server_default='pending'),
        sa.Column('last_error', sa.Text(), nullable=True),
        sa.Column('last_error_at', sa.DateTime(timezone=True), nullable=True),
        sa.Column('last_sync_at', sa.DateTime(timezone=True), nullable=True),
        sa.Column('last_sync_status', syncstatus_enum, nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('account_type', custodianaccounttype_enum, server_default='individual'),
    ...
    op.create_table(
        ...
        sa.Column('asset_class', custodianassetclass_enum, server_default='other'),
    ...
    op.create_table(
        ...
        sa.Column('transaction_type', custodiantransactiontype_enum, nullable=False),
