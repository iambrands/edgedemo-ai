...
class Config:
    ...
    if database_url.startswith('postgresql://'):
        ...
        SQLALCHEMY_ENGINE_OPTIONS = {
            ...
            'pool_recycle': 1800,  # Recycle connections every 30 min (avoids stale/failed connections)
            'pool_pre_ping': True,  # Test connections before use (prevents poisoned connection reuse)
