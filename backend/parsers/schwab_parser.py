...
class SchwabParser(BaseStatementParser):
    """Parse Charles Schwab statements."""

    def can_handle(self, raw_text: str) -> bool:
        text = raw_text.upper()
        return "CHARLES SCHWAB" in text or "SCHWAB" in text
    ...
    def parse(self, raw_text: str) -> ParsedStatement:
        ...
        for i, line in enumerate(lines):
            ...
            if not line:
                continue
            if "account" in line.lower() and ("number" in line.lower() or "#" in line):
            ...
            if "total" in line.lower() or "account value" in line.lower():
                ...
                if match:
                    try:
                        ...
                        pass
            if "intelligent" in line.lower() or "robo" in line.lower():
                result.metadata["intelligent_portfolio"] = True
