...
_ARTICLES = [
    # Getting Started
    {"id": "1", "category": "getting-started", "audience": "ria", "title": "Complete Setup Guide", "excerpt": "Step-by-step guide to setting up your Firmum account", "readTime": "10 min", "type": "guide"},
    ...
    {"id": "3", "category": "getting-started", "audience": "ria", "title": "Platform Overview Video", "excerpt": "Quick tour of all Firmum features", "readTime": "8 min", "type": "video"},
    # Client Management
...
_RIA_FAQS = [
    ...
    {"question": "Is my client data secure?", "answer": "Yes. Firmum uses bank-level 256-bit AES encryption, SOC 2 Type II compliance, and all data is stored in secure AWS data centers. We never share your data with third parties."},
