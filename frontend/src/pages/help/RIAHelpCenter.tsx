...
const SUPPORTED_BROKERAGES: Brokerage[] = [
  { name: 'Charles Schwab', integration: 'Direct API', accounts: ['Individual', 'Joint', 'IRA', 'Roth IRA', 'Trust', '401(k)', '403(b)', '457(b)', 'SEP IRA', 'Pension Rollover'] },
  { name: 'Fidelity Investments', integration: 'Direct API', accounts: ['Individual', 'Joint', 'IRA', 'Roth IRA', '529', 'HSA', '403(b)', '457(b)', 'TSP', 'Inherited IRA'] },
  { name: 'TD Ameritrade', integration: 'Direct API', accounts: ['Individual', 'Joint', 'IRA', 'Roth IRA', 'Trust', '403(b)'] },
  { name: 'Pershing (BNY Mellon)', integration: 'Direct API', accounts: ['Individual', 'Joint', 'IRA', 'Advisory', '403(b)', '457(b)', 'Pension Rollover'] },
  { name: 'Interactive Brokers', integration: 'Direct API', accounts: ['Individual', 'Joint', 'IRA', 'Trust', 'LLC'] },
  { name: 'E*TRADE (Morgan Stanley)', integration: 'CSV/XLSX Import', accounts: ['Individual', 'Joint', 'IRA', 'Roth IRA', '401(k)', '403(b)'] },
  { name: 'Vanguard', integration: 'CSV/XLSX Import', accounts: ['Individual', 'Joint', 'IRA', 'Roth IRA', '529', '403(b)', 'TSP', 'Inherited IRA'] },
  { name: 'Robinhood', integration: 'CSV/XLSX Import', accounts: ['Individual', 'IRA', 'Roth IRA'] },
  { name: 'Merrill Lynch', integration: 'CSV/XLSX Import', accounts: ['Individual', 'Joint', 'IRA', 'Trust', '401(k)', 'Pension Rollover'] },
  { name: 'Northwestern Mutual', integration: 'CSV/XLSX Import', accounts: ['Variable Annuity IRA', 'Advisory', '403(b)'] },
  { name: 'Edward Jones', integration: 'CSV/XLSX Import', accounts: ['Individual', 'Joint', 'IRA', 'Roth IRA', '403(b)', '457(b)'] },
  { name: 'Raymond James', integration: 'CSV/XLSX Import', accounts: ['Individual', 'Joint', 'IRA', 'Trust', '403(b)', 'Pension Rollover'] },
  { name: 'LPL Financial', integration: 'CSV/XLSX Import', accounts: ['Individual', 'Joint', 'IRA', 'Advisory', '403(b)', '457(b)'] },
  ...
  { name: 'TIAA', integration: 'CSV/XLSX Import', accounts: ['403(b)', '457(b)', 'IRA', 'Roth IRA', 'SIMPLE IRA', 'Pension Rollover'] },
